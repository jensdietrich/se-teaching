package nz.ac.vuw.jenz.asm.staticanalysis4;

import nz.ac.vuw.jenz.asm.staticanalysis4.FindCallsites;
...
public class TestFindCallsites {
    ...
    public void testCallsites() throws IOException {
        File classes = new File("target/test-classes/nz/ac/vuw/jenz/asm/staticanalysis4/data");
